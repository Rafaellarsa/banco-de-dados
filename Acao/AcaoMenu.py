...
class AcaoMenu(object):
    ...
    def menu_cadastrar_acoes_listar_todas_acoes(self):
        ...
        for a in acoes:
            print("*** Id: " + str(a.id_acao) + " - Local: " + a.local + " - Número de beneficiários: " + a.num_beneficiados + " - Número de voluntários: " + a.num_voluntarios + " - Id do tipo de ação: " + str(a.id_tipo_acao) + " - Id do voluntário: " + str(a.id_voluntario_responsavel) + " ***")
    ...
    def menu_cadastrar_acoes_listar_uma_acao(self):
        ...
        if acao is not None:
            print("*** Id: " + str(acao.id_acao) + " - Local: " + acao.local + " - Número de beneficiários: " + acao.num_beneficiados + " - Número de voluntários: " + acao.num_voluntarios + " - Id do tipo de ação: " + str(acao.id_tipo_acao) + " - Id do voluntário: " + str(acao.id_voluntario_responsavel) + " ***")
        else:
